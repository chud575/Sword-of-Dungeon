...
const LEG_X = 11, LEG_Y = 25, TORSO_Y = 10, HEAD_Y = 0;
...
// ------------------------------------------------------------------------------------ shared legs
// 18 wide, 12 tall, stamped at (LEG_X, LEG_Y): two 3-px legs with a 2-px gap, boots flaring outward.
...
function frame(S, f, o = {}) {
  ...
  return houseOutline(softenLit(compose(MON_W, MON_H, layers)), { key: '#', litKey: '@', lit: LIT });
}
...
..#eeefeeeeee#..
...#eefeeeee#...
....#eeeeee#....`, [['123', { gain: 0.60, mid: 0.50, up: 0.52, local: 0.42, dome: 0.08 }], ['efg', { gain: 0.56, mid: 0.44, up: 0.48, local: 0.46, dome: 0.06 }], ['7456', { gain: 0.58, mid: 0.50, up: 0.50, local: 0.40, dome: 0.08 }]]);
